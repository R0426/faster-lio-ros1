...
def main(config):
    ...
    data_loader = get_loader(config.model, 
                             config.image_path, 
...
if __name__ == '__main__':
    ...
    # 경로들
    parser.add_argument('--image_path', type=str, default='./zed_sync_test_images')
    parser.add_argument('--metadata_path', type=str, default='./matched_gt_test_sync.txt')
    ...
    parser.add_argument('--save_result', type=bool, default=True,
                        help='Save pose_true.csv and pose_estim.csv when testing')
